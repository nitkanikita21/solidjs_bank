...
-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('IN', 'OUT', 'SYSTEM');
...
-- AddForeignKey
ALTER TABLE "Transaction" ADD CONSTRAINT "Transaction_inCardId_fkey" FOREIGN KEY ("inCardId") REFERENCES "Card"("id") ON DELETE SET NULL ON UPDATE CASCADE;
